...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'VoitureFixtures.php';
        ...
        $instance->addFixtures([['fixture' => ($container->privates['App\\DataFixtures\\AppFixtures'] ??= new \App\DataFixtures\AppFixtures()), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\CategorieFixtures'] ??= new \App\DataFixtures\CategorieFixtures()), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\ClientFixtures'] ?? $container->load('getClientFixturesService')), 'groups' => []], ['fixture' => ($container->privates['App\\DataFixtures\\VoitureFixtures'] ??= new \App\DataFixtures\VoitureFixtures()), 'groups' => []]]);
