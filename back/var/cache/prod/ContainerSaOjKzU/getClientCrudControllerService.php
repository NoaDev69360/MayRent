 ...
 */
class getClientCrudControllerService extends App_KernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'ClientCrudController.php';

        $container->services['App\\Controller\\Admin\\ClientCrudController'] = $instance = new \App\Controller\Admin\ClientCrudController();

        $instance->setContainer(($container->privates['.service_locator.Z7xq1n_'] ?? $container->load('get_ServiceLocator_Z7xq1nService'))->withContext('App\\Controller\\Admin\\ClientCrudController', $container));
