...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $container->services['doctrine.dbal.default_connection'] = $instance = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([], new \Doctrine\DBAL\Tools\DsnParser(['db2' => 'ibm_db2', 'mssql' => 'pdo_sqlsrv', 'mysql' => 'pdo_mysql', 'mysql2' => 'pdo_mysql', 'postgres' => 'pdo_pgsql', 'postgresql' => 'pdo_pgsql', 'pgsql' => 'pdo_pgsql', 'sqlite' => 'pdo_sqlite', 'sqlite3' => 'pdo_sqlite'])))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'sslmode' => 'require', 'sslcert' => (\dirname(__DIR__, 4).'/config/ssl/client-cert.pem'), 'sslkey' => (\dirname(__DIR__, 4).'/config/ssl/client-key.pem'), 'sslrootcert' => (\dirname(__DIR__, 4).'/config/ssl/server-ca.pem'), 'use_savepoints' => true, 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [1002 => 'SET SESSION sql_mode=(SELECT CONCAT(@@sql_mode, \',ONLY_FULL_GROUP_BY\'))'], 'defaultTableOptions' => []], $b, $a, []);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\CategorieController', 'App\\Controller\\InscriptionController', 'App\\Controller\\ReservationController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('It48ZgdMP8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
